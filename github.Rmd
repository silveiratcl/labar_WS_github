...
Para colaborar em um repositório você antes de mais nada copiar os arquivos para o seu **Github**. Essa ação é executada com o comando `fork` `r icon_fork`. Por exemplo, se dirija ao [respositório de teste](https://github.com/ufsclabar/repo_test target="_blank") e localize no alto da página o botão `fork` `r icon_fork`. Depois escolha onde você gostaria de colocar, escolha seu usuário. No canto esquerdo da página mostrará que o repo está em seu usuário também. 
...
Faça alguma alteração no script, insira seu nome como indicado no arquivo, depois faça `commit` `r icon_commit` e `push` `r icon_push`. Note que seu repositório será atualizado. Navegue até o  [respositório de teste](https://github.com/ufsclabar/repo_test) recém clonado e clique em **Contribute**.
...
Clique novamente no botão **Create pull request** para confirmar sua contribuição. Visualize a página   [https://github.com/ufsclabar/repo_test](https://github.com/ufsclabar/repo_test) e veja como ficou.
